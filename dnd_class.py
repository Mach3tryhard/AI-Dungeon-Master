...
class DNDClass:
    def __init__(self, name: str = "", primary_stat: int = "", health: int = 0, skill_proficiencies = None, weapon_proficiencies = None,
                 abilites = None, cantrips = None, max_cantrips = 0, spells=None, max_spells=0, spell_slots=0):
        self.name = name
